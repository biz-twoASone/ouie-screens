// android-tv/app/src/main/java/app/ouie/screens/update/PackageInstallerHelper.kt
...
package app.ouie.screens.update
...
class PackageInstallerHelper(
    ...
    override suspend fun install(versionCode: Int, apk: File) = withContext(Dispatchers.IO) {
        ...
        installer.openSession(sessionId).use { session ->
            ...
            // status extras.
            val statusIntent = Intent("app.ouie.screens.OTA_INSTALL_STATUS")
