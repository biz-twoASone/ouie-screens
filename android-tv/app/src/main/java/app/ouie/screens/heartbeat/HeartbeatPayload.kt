// android-tv/app/src/main/java/app/ouie/screens/heartbeat/HeartbeatPayload.kt
package app.ouie.screens.heartbeat

import app.ouie.screens.errorbus.ErrorEvent
...
data class CacheStorageInfo(
     ...
     */
    val preload: app.ouie.screens.preload.PreloadStatus? = null,
)
